## Introduction_Training_CROWNBasics
Basic example of using CROWNs within your SensorApp
...
The purpose of this one is to get familiar with the usage of CROWNs provided by
the AppEngine available on the SICK AppSpace programmable device to run your
SensorApp.

### Topics
training, introduction, crown, appengine, sampleapp, sick-appspace
